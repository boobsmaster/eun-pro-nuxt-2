...
export default {
  name: "SearchBlock",
  components: { Button, Icon, Autocomplete },
  props: {
  ...
  data() {
    const options = [
      ...
      {
        name: "Экспертиза сметной документации",
        path: "/",
      },
      {
